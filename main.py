...
try:
    data = pandas.read_csv(
        "python_practice_flash_card_man_to_span_app_capstone/data/words_to_learn.csv"
    )
    # print(data)
except FileNotFoundError:
    original_data = pandas.read_csv(
        "python_practice_flash_card_man_to_span_app_capstone/data/mandarin_english_spanish_words.csv"
    )
...
card_front_img = PhotoImage(
    file="python_practice_flash_card_man_to_span_app_capstone/images/card_front.png"
)
card_back_img = PhotoImage(
    file="python_practice_flash_card_man_to_span_app_capstone/images/card_back.png"
)
...
cross_image = PhotoImage(
    file="python_practice_flash_card_man_to_span_app_capstone/images/wrong.png"
)
...
check_image = PhotoImage(
    file="python_practice_flash_card_man_to_span_app_capstone/images/right.png"
)
